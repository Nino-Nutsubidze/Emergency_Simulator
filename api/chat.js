export async function GET() {
  return json({ ok:true, route:'/api/chat', hasApiKey:!!process.env.ANTHROPIC_API_KEY, message: process.env.ANTHROPIC_API_KEY ? 'API key detected.' : 'Missing ANTHROPIC_API_KEY environment variable.' });
}
